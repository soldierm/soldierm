...
<head>
    ...
    <style><?php echo $allMinCss ?></style>
    <link href="https://fonts.googleapis.com/css?family=Nunito:200,200i,300,300i,400,400i,600,600i,700,700i,800,800i,900,900i"
          rel="stylesheet">

    <!-- Custom styles for this template-->
    <style><?php echo $sbAdmin2Css ?></style>
...
<script><?php echo $jqueryJs ?></script>
<script><?php echo $bootstrapBundleJs ?></script>

<!-- Core plugin JavaScript-->
<script><?php echo $jqueryEasingJs ?></script>

<!-- Custom scripts for all pages-->
<script><?php echo $sbAdmin2Js ?></script>
